...
CREATE TABLE [Samurais] (
    ...
    CONSTRAINT [FK_Samurais_Clans_ClansId] FOREIGN KEY ([ClansId]) REFERENCES [Clans] ([Id]) ON DELETE NO ACTION
);
...
CREATE INDEX [IX_Samurais_ClansId] ON [Samurais] ([ClansId]);

GO

INSERT INTO [__EFMigrationsHistory] ([MigrationId], [ProductVersion])
VALUES (N'20200907105143_init', N'3.1.7');
